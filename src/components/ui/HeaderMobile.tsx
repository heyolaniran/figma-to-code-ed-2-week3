...
export default function HeaderMobile() {
    ...
    return (
        <div className={`lg:hidden  `}>
            ...
            <div className={clsx(`fixed h-full w-screen lg:hidden bg-black/50 backdrop-blur-sm top-0 right-0 -translate-x-0 transition-all  ${open ? '' : 'hidden'}`, 
                open && 'translate-x-0'
            )}>
                <section className="text-black rounded-r-md bg-slate-50 flex-col absolute left-0 h-screen justify-between  w-56 p-8 flex z-50 top-0">
                    ...
                    <div className="flex-col ">
                        <div className="flex justify-end mb-4 items-center">
                            <Image src={'/icons/close.svg'} width={20} height={20} alt="" onClick={() => SetIsOpen(false) } className="p-1 bg-slate-300 rounded-md " />
                        </div>
                        <div className="mt-4">
                        ...
                        <div className="flex items-center gap-2">
                            <div className="flex gap-2">
                                ...
                                <div className="block">
                                    ...
                                    <span className="text-slate-400 text-xs truncate">johndoe@gmail.com</span>
                                </div>
                            </div>
                            <div>
